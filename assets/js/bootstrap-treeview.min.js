    ...
    g.prototype.init = function(b) {
        ...
        if (b) {
            ...
            a.each(b, function(b, e) {
                ...
                var h = [];
                if (e.nodes ? (h.push("expand-icon"), h.push(e.state.expanded ? d.options.collapseIcon : d.options.expandIcon)) : h.push(d.options.emptyIcon), f.append(a(d.template.link).attr("href", e.href).append(a(d.template.icon).addClass(h.join(" "))).append(e.text)), d.options.showIcon) {
                    var h = ["node-icon"];
                ...
                return d.options.showTags && e.tags && a.each(e.tags, function(b, c) {
        ...
        list: '<ul class="acc-menu"></ul>',
        item: '<li></li>',
        indent: '<span class="indent"></span>',
        icon: '<i class=""></i>',
        link: '<a href="#" style="color:inherit;"></a>',
        link_open: '<a href="#" style="color:inherit;">',
        link_close: '</a>',
