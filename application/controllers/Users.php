...
class Users extends MY_Controller {
    ...
    function index()
    {
        ...
        elseif (!$this->user->is_admin()) {
            ...
            $this->data['projects'] = $this->userProjects;
            $this->data['users'] = $this->user->get_all_project_managers($this->userProjects);
            ...
            foreach ($this->data['users'] as $key => $user) {
                $this->data['users'][$key]->groups = $this->user->get_users_groups($user->id)->result();
            }
